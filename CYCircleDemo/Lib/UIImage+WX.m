...
//        YYEKTLog(@"No pixelbuffer");
    ...
    if (error) {
//        YYEKTLog(@"error from convolution %ld", error);
    }
...
- (UIImage *)imgWithBlur
{
    return [self imgWithLightAlpha:0 radius:45 colorSaturationFactor:0.618];
}

- (UIImage *)imgWithLightAlpha:(CGFloat)alpha radius:(CGFloat)radius colorSaturationFactor:(CGFloat)colorSaturationFactor
{
    UIColor *tintColor = [UIColor colorWithWhite:0.0 alpha:alpha];
